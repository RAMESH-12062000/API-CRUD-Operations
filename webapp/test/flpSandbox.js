		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "API CRUD",
									"targetURL": "#comappapicrudoperations-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappapicrudoperations-display": {
								"semanticObject": "comappapicrudoperations",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.apicrudoperations",
									"url": sap.ui.require.toUrl("com/app/apicrudoperations")
								}
							}
						}
					}
